...
@section('content')
    ...
    <div class="container absolute inset-x-0 fieldset z-30 xxs:px-0 lg:px-28 xl:px-48 xxs:text-center xs:text-center md:text-left lg:text-left xl:text-left xxs:-mt-32 xs:-mt-36 sm:-mt-48 md:-mt-80 lg:-mt-48 xl:-mt-64">
        ...
        <div class="grid grid-cols-3 xxs:gap-1 gap-y-10 pt-10 sm:gap-x-6 md:gap-x-14 lg:gap-x-14 xl:gap-x-20 md:pt-12">
            <div class="flex flex-col justify-between items-center shadow-amplia bg-white rounded-lg sm:px-8 md:px-8 lg:px-20 xxs:py-12 xs:py-12 sm:py-12 md:py-12 xl:py-20">
                <div class="pb-4">
            ...
            <div class="flex flex-col justify-between items-center shadow-amplia bg-white rounded-lg sm:px-8 md:px-8 lg:px-20 xxs:py-12 xs:py-12 sm:py-12 md:py-12 xl:py-20">
                <div class="pb-4">
                    <img src="{{ asset('/img/card_03.png') }}" alt="card_03" class="xxs:w-20"/>
                </div>
                <div class="flex items-center text-center">
                    <h3 class="text-color-cucchiara xxs:text-xs sm:text-lg font-body font-bold lg:text-xl xl:text-2xl">
                        Brokerage
    ...
    {{-- end cards --}}
    <div class="xxs:h-c-32 xs:h-c-34 sm:h-[23rem] md:h-60 lg:h-[25rem] xl:h-96"></div>
    {{-- open account --}}
