                        ...
                        <div class="hidden lg:block">
                            <ul class="flex items-center pt-5 nav-fondos">
                                <li class="group pl-20">
                                    <a href="/nosotros">
                                        <span @if(request()->is('acercade')) class="selected-menu-underline hover-underline-animation cursor-pointer pt-0.5 font-body font-bold text-primary text-color-cucchiara" @else class="hover-underline-animation cursor-pointer pt-0.5 font-body font-bold text-primary text-color-cucchiara" @endif>About Us</span>
                                    </a>
                                </li>
                                <li class="group pl-20">
                                    <a href="/servicios">
