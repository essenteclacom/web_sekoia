                ...
                <div class="hidden grid pb-20 pt-6 gap-1 xxs:grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 xxs:place-items-center xs:place-items-center sm:place-items-start" id="menu">
                    ...
                    <div class="flex text-a-color xxs:pt-4 xs:mt-10 sm:-mt-10">
                        ...
                        <div class="flex flex-col hidden list" id="lista-01">
                            <a href="" class="flex flex-row items-center"><span class="border-l-1 border-1 border-a-color h-8 absolute ml-[5px]"> </span><img src="{{ asset('/img/Ellipse.png')}}" class="w-auto h-3 pr-4"><span class="text-secundary">Resumen fondo CyC Liquidez 04.11.2023</span></a>
                            <a href="" class="flex flex-row items-center"><span class="border-l-1 border-1 border-a-color h-8 absolute ml-[5px]"> </span><img src="{{ asset('/img/Ellipse.png')}}" class="w-auto h-3 pr-4"><span class="text-secundary">Resumen fondo CyC Liquidez 04.11.2023</span></a>
                            <a href="" class="flex flex-row items-center"><span class="border-l-1 border-1 border-a-color h-8 absolute ml-[5px]"> </span><img src="{{ asset('/img/Ellipse.png')}}" class="w-auto h-3 pr-4"><span class="text-secundary">Resumen fondo CyC Liquidez 04.11.2023</span></a>
                            <a href="" class="flex flex-row items-center"><span class="border-l-1 border-1 border-a-color h-8 absolute ml-[5px]"> </span><img src="{{ asset('/img/Ellipse.png')}}" class="w-auto h-3 pr-4"><span class="text-secundary">Resumen fondo CyC Liquidez 04.11.2023</span></a>
                        </div>
                        <div class="flex flex-col hidden list" id="lista-02">
                            <a href="" class="flex flex-row items-center"><span class="border-l-1 border-1 border-a-color h-8 absolute ml-[5px]"> </span><img src="{{ asset('/img/Ellipse.png')}}" class="w-auto h-3 pr-4"><span class="text-secundary">Presentación Fondos CyC Liquidez 04.11.2023</span></a>
                            <a href="" class="flex flex-row items-center"><span class="border-l-1 border-1 border-a-color h-8 absolute ml-[5px]"> </span><img src="{{ asset('/img/Ellipse.png')}}" class="w-auto h-3 pr-4"><span class="text-secundary">Presentación Fondos CyC Liquidez 04.11.2023</span></a>
                            <a href="" class="flex flex-row items-center"><span class="border-l-1 border-1 border-a-color h-8 absolute ml-[5px]"> </span><img src="{{ asset('/img/Ellipse.png')}}" class="w-auto h-3 pr-4"><span class="text-secundary">Presentación Fondos CyC Liquidez 04.11.2023</span></a>
                            <a href="" class="flex flex-row items-center"><span class="border-l-1 border-1 border-a-color h-8 absolute ml-[5px]"> </span><img src="{{ asset('/img/Ellipse.png')}}" class="w-auto h-3 pr-4"><span class="text-secundary">Presentación Fondos CyC Liquidez 04.11.2023</span></a>
                        </div>
