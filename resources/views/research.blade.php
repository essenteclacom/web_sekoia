    ...
    <div style="background-image: url({{ asset('/img/background_work.png')}})" class="bg-cover bg-center bg-no-repeat xxs:h-48 xs:h-48 sm:h-84 lg:h-64 xl:h-96">
        <div class="container flex items-center justify h-full">
            <p class="font-body text-white text-center text-shadow xxs:text-xxs xs:text-base sm:text-1xl md:text-2xl lg:text-2xl xl:text-2xl">
                We guide our recommendations based on fundamentals. We regularly publish
economic and market research reports, providing valuable information for our
clients
            </p>
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-20 bg-quarter flex flex-col items-center rounded-lg">
                    <h3 class="mb-4 text-2xl font-bold text-white">Get our weekly Newsletter</h3>
                            ...
                            <div class="flex flex-col">
                                <div>
                                    <h3 class="text-base text-white mb-4">
                                        Choose which one you want receive:
                                    </h3>
                                </div>
                                <div class="flex flex-row">
                                    ...
                                    <label for="remember" class="ml-2 text-sm font-medium text-white">Stadistic Summary</label><br>
                                </div>
                                <div class="flex flex-row">
                                    <div class="flex items-center h-5">
                                        <input id="remember" type="checkbox" value="" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300" required>
                                    </div>
                                    <label for="remember" class="ml-2 text-sm font-medium text-white">Economical brief</label>
                                </div>
                            </div>
                        </div>
